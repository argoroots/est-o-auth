  ...
  <section>
    ...
    <ol>
      <li>
        ...
        <pre>https://oauth.ee/auth/mobile-id?response_type=code&client_id=QVnPZGdcXQ8Ev4mx&redirect_uri=https://example.com/auth/callback&scope=&state=5600684163565994</pre>
        <p>
