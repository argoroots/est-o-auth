...
async function postEmail (headers, params, res) {
  ...
  const url = `${process.env.EMAIL_URL}?response_type=code&scope=openid&client_id=${params.client_id}&redirect_uri=${params.redirect_uri}&state=${params.state}&email=${params.email}&code=${code}`
